...
model_bg = ResNet().to(device)
model_bger = Attention_ResNet().to(device)
...
if __name__ == '__main__':
    ...
    plt.subplot(1,2,1)
    plt.plot(loss_sm,label='convolution')
    plt.plot(loss_bg,label='residual')
    plt.plot(loss_bger,label='attention')
    plt.xlabel('epoch')
    plt.ylabel('loss')
    plt.legend()

    plt.subplot(1,2,2)
    plt.plot(acc_sm,label='convolution')
    plt.plot(acc_bg,label='residual')
    plt.plot(acc_bger,label='attention')
    plt.xlabel('epoch')
    plt.ylabel('accuracy')
    plt.legend()

    plt.savefig('dump/compare_net.png')
